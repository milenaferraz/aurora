...
namespace Aurora.Application.Knowledge
{
    public class KnowledgeService : IMemoryService
    {
        ...
        public async Task<MemoryResponse> CreateAsync(CreateMemoryRequest request, CancellationToken cancellationToken = default)
        {
            ...
            // Validate Type
            if (!Enum.TryParse<Aurora.Domain.Knowledge.MemoryType>(request.Type, true, out var memoryType))
            ...
            var memory = new Aurora.Domain.Knowledge.Memory(
            ...
            {
                Aurora.Domain.Knowledge.MemoryType.Decision => "03-Decisions",
                Aurora.Domain.Knowledge.MemoryType.Fact => "01-Memory/Facts",
                Aurora.Domain.Knowledge.MemoryType.Project => "02-Projects",
                Aurora.Domain.Knowledge.MemoryType.Person => "01-Memory/People",
                Aurora.Domain.Knowledge.MemoryType.Preference => "01-Memory/Preferences",
                Aurora.Domain.Knowledge.MemoryType.Knowledge => "04-Knowledge",
                Aurora.Domain.Knowledge.MemoryType.Meeting => "08-Meetings",
                Aurora.Domain.Knowledge.MemoryType.Agent => "05-Agents",
                Aurora.Domain.Knowledge.MemoryType.Incident => "09-Incidents",
                Aurora.Domain.Knowledge.MemoryType.Note => "00-Inbox",
                _ => "00-Inbox"
            };
        ...
        public Task<MemoryResponse?> GetByIdAsync(Guid id, CancellationToken cancellationToken = default)
        {
            throw new NotImplementedException();
        }

        public Task<MemoryResponse> UpdateAsync(Guid id, UpdateMemoryRequest request, CancellationToken cancellationToken = default)
        {
            throw new NotImplementedException();
        }
    }
